...
Config.instname = "NMBU"
Config.profilename = "Eduroam @ NMBU"
Config.url = "https://support.nmbu.no"
Config.email = "it@nmbu.no"
Config.title = "eduroam CAT"
Config.server_match = "nmbu.no"
...
Config.user_realm = "nmbu.no"
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.servers = ['DNS:SDA-ISE-P-1-01.nmbu.no', 'DNS:SDA-ISE-P-2-01.nmbu.no', 'DNS:radius05.nmbu.no', 'DNS:radius06.nmbu.no']
